...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 02-Maio-2023 às 23:38
...
(33, 'Vinicius Maia Marciano', 2147483647, 935453833, 'Rua Silvestre Pereira Soares', 294, '1A', '3700-156', 7),
(34, 'Luiza Rocha Maia', 2147483647, 2147483647, 'Rua Minas ', 236, 'B1', '2597-555', 8);
...
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `cliente_ibfk_1` FOREIGN KEY (`idCidade_FK`) REFERENCES `cidade` (`idCidade`);
